...
// let prueba = new ProductManager('data/data.json')
...
// console.log(prueba.updateProduct('abc123',{ title: 'producto prueba', description: 'Este es un producto prueba', price: 300, thumbnail: 'Sin imagen', id: 'abc123', stock: 25 }))
// console.log(prueba.getProducts())
//console.log(prueba.deleteProduct('abc123'))
